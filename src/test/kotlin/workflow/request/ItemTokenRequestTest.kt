...
class ItemTokenRequestTest(val expectedResponse: BaseWebserviceResponse,
                           val systemUnderTest: ItemTokenRequest) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            return listOf(
                    arrayOf(BaseWebserviceResponse(HttpStatus.BAD_REQUEST, WSCode.ERROR_WRONG_FIELD, WSCode.ERROR_WRONG_FIELD.code, WSString.USER_ITEM_TOKEN_INVALID.tag), ItemTokenRequest("")),
                    arrayOf(BaseWebserviceResponse(HttpStatus.OK, WSCode.OK, WSCode.OK.code, ""), ItemTokenRequest("token"))
            )
        }
    }
